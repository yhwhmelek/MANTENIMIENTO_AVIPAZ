...
const colorFor=plan=>{const key=identity(plan);let hash=0;for(const char of key)hash=(hash*31+char.charCodeAt(0))>>>0;return palette[hash%palette.length]}
